    ...
    <div class="programs-container">
        ...
        <div class="each-prog-proj-container" :class="[$vuetify.breakpoint.mdAndUp ? 'large' : 'small']">
            <div class="prog-proj-info">
                ...
                <p class="proj-prog-description" :class="[$vuetify.breakpoint.mdAndUp ? 'body-1' : 'body-2']"> FRW provides academic scholarships to children who are part of the organization, based on merit. On average, providing primary education costs approximately $100 USD per child. These scholarships cover tuition fees, uniforms, school supplies, books and exams. Click here to support our scholarship program! </p>
            </div>
