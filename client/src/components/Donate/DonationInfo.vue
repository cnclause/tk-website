<template>
    <div class="donation-info">
        ...
        <v-img :class="[$vuetify.breakpoint.mdAndUp ? 'large' : 'small']" 
            src="https://rootstowingspictures.s3-us-west-1.amazonaws.com/CharmaDonatePic-outsideSchool.jpg"
            class="hidden-sm-and-down donate-img"
        >
        </v-img>
    </div>
</template>
